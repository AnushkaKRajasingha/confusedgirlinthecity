<?php get_header(); ?>
	...
	<div class="container"> 
		...
		<div class="span8">
                ...
                // echo apply_filters('the_content', get_post_meta($post->ID, 'embed_post', true));                				
								//echo '<img src="http://i2.ytimg.com/vi/'.get_post_meta($post->ID, 'youtubevidid', true).'/0.jpg" alt="'.$post->post_title.'" />';
                				
                			?>
                			<img src="<?php echo get_template_directory_uri(); ?>/images/youtube_btn.png" class="youtubebtn">
                			</a>                			
                        </div> 
