<?php  get_header();  ?>
	...
	<div class="container">  
<script type="text/javascript" language="javascript" src="http://www2.glam.com/app/site/affiliate/viewChannelModule.act?mName=viewAdJs&affiliateId=1725986561&adSize=160x600"></script> 
		<div class="row">
        	<div class="span8">
            	<?php while (have_posts()) : the_post(); ?>
                    ...
                    <article id="post-<?php  the_ID(); ?>" <?php  post_class('clearfix post-content'); ?>>
                        <div class="video clearfix">
                         ...
                         <div class="clerfix post-image" style="display:none;">
