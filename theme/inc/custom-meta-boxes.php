...
function rdn_metabox() {
    wp_enqueue_script('custom-meta-boxes', get_template_directory_uri() . '/inc/js/custom-meta-boxes.js', array('jquery'),'', true);
}    
...
<p id="embed-post-code" style="display:none;">
    ...
    <small>Insert the link for video/podcast here.</small>
</p>
