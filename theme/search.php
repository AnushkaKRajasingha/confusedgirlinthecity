<?php get_header(); ?>
	...
	<div class="spacing40 clearfix"></div>
     <div class="container"> 
     	<p id="breadcrumbs">Show result for <strong>"<?php the_search_query() ?>"</strong></p>  
    	<div class="row">
                <div class="span8">
					...
					<?php endwhile; else: ?><!--if no search result-->
                    	<h3 class="search-result"><i class="icon-remove-sign"></i> Nothing found for "<?php the_search_query() ?>"!</h3>
                    <?php endif; ?>
